...
def start_screen():
    ...
    while True:
        ...
        draw_text("Arrow Keys to move | ENTER to select", pygame.font.SysFont("comicsans", 20), WHITE, WIDTH//2, 340)
        pygame.display.flip()
...
def game_over_screen(score):
    ...
    while True:
        ...
        draw_text("Press ENTER to return to menu", pygame.font.SysFont("comicsans", 20), WHITE, WIDTH//2, 300)
        pygame.display.flip()
